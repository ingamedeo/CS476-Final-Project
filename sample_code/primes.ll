...
@.str.2 = private unnamed_addr constant [45 x i8] c"1 is neither a prime nor a composite number.\00", align 1
@.str.3 = private unnamed_addr constant [22 x i8] c"%d is a prime number.\00", align 1
@.str.4 = private unnamed_addr constant [26 x i8] c"%d is not a prime number.\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0))
...
25:                                               ; preds = %22
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0))
  br label %37
...
30:                                               ; preds = %27
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i64 0, i64 0), i32 %31)
  br label %36

33:                                               ; preds = %27
  %34 = load i32, i32* %2, align 4
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4, i64 0, i64 0), i32 %34)
  br label %36
